import{b as h,e as s,E as l}from"./index-BuRPltC2.js";class m{manager;container;themeButtons=new Map;constructor(e){this.manager=h.getInstance();const t=document.getElementById(e);if(!t)throw new Error(`Container ${e} not found`);this.container=t,this.init()}init(){this.container.innerHTML="",this.container.className="theme-selector",this.applyStyles(),this.renderThemes(),console.log("✅ ThemeSelector initialized")}applyStyles(){const e=document.createElement("style");e.textContent=`
      .theme-selector {
        display: flex;
        flex-wrap: wrap;
        gap: 12px;
