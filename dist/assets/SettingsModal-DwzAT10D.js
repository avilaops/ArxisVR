import{e as n,E as l,a as d,R as t,c as r,C as c}from"./index-BuRPltC2.js";class m{modal=null;isVisible=!1;constructor(){this.init()}init(){this.applyStyles(),this.listenEvents()}listenEvents(){n.on(l.UI_SETTINGS_OPEN,()=>{this.open()})}applyStyles(){const e=document.createElement("style");e.textContent=`
