import{e as i,E as d,a as c,c as m,C as p}from"./index-BuRPltC2.js";class u{modal=null;isVisible=!1;constructor(){this.init()}init(){this.applyStyles(),this.listenEvents()}listenEvents(){i.on(d.UI_MODAL_OPEN,e=>{e.modal==="network-connect"&&this.open()})}applyStyles(){const e=document.createElement("style");e.textContent=`
