import{e as a,E as r}from"./index-BuRPltC2.js";class i{modal=null;isVisible=!1;constructor(){this.init()}init(){this.applyStyles(),this.listenEvents()}listenEvents(){a.on(r.UI_MODAL_OPEN,t=>{t.modal==="shortcuts"&&this.open()})}applyStyles(){const t=document.createElement("style");t.textContent=`
